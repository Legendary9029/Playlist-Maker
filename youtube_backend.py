...
def process_excel(file_path):
    """Read an Excel file containing YouTube links."""
    df = pd.read_excel(file_path)
    return df


def export_playlist_to_excel(video_list, output_file="playlist.xlsx"):
    """Export the merged playlist videos to an Excel file."""
